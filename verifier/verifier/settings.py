...
SECRET_KEY = 'django-insecure-i@l2ungoc*jv@s^ateejdnd#blo9y7yxriyp=wvq^!r!)f%zrt'
...
BASE_URL = ['http://localhost:8000', 'https://verifier-cryptographically-secure.onrender.com']